...
checkUnnamed0(core.Map<core.String, core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals(42));
  unittest.expect(o["y"], unittest.equals(42));
}

core.int buildCounterImportBatch = 0;
buildImportBatch() {
  var o = new api.ImportBatch();
  buildCounterImportBatch++;
  if (buildCounterImportBatch < 3) {
    o.finished = true;
    o.id = "foo";
    o.importCounts = buildUnnamed0();
    o.source = "foo";
...
checkImportBatch(api.ImportBatch o) {
  buildCounterImportBatch++;
  if (buildCounterImportBatch < 3) {
    unittest.expect(o.finished, unittest.isTrue);
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed0(o.importCounts);
...
checkUnnamed2(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListOfImportBatch() {
  var o = new api.ListOfImportBatch();
  o.add(buildImportBatch());
  o.add(buildImportBatch());
  return o;
}

checkListOfImportBatch(api.ListOfImportBatch o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImportBatch(o[0]);
  checkImportBatch(o[1]);
}
...
checkUnnamed8(core.List<api.ImportResult> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed11(core.List<api.TagInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagInfo(o[0]);
  checkTagInfo(o[1]);
}
...
checkUnnamed13(core.List<api.Tag> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTag(o[0]);
  checkTag(o[1]);
}
...
buildReplaceTagsRequest() {
  ...
  if (buildCounterReplaceTagsRequest < 3) {
    o.newTags = buildUnnamed12();
    o.originalTags = buildUnnamed13();
  }
  buildCounterReplaceTagsRequest--;
  return o;
}
...
checkReplaceTagsRequest(api.ReplaceTagsRequest o) {
  buildCounterReplaceTagsRequest++;
  if (buildCounterReplaceTagsRequest < 3) {
    checkUnnamed12(o.newTags);
    checkUnnamed13(o.originalTags);
  }
  buildCounterReplaceTagsRequest--;
}
...
main() {
  ...
  unittest.group("obj-schema-ImportBatch", () {
    unittest.test("to-json--from-json", () {
      var o = buildImportBatch();
      var od = new api.ImportBatch.fromJson(o.toJson());
      checkImportBatch(od);
    });
  });
  ...
  unittest.group("obj-schema-ListOfImportBatch", () {
    unittest.test("to-json--from-json", () {
      var o = buildListOfImportBatch();
      var od = new api.ListOfImportBatch.fromJson(o.toJson());
      checkListOfImportBatch(od);
    });
  });
  ...
  unittest.group("resource-ExtensionDataResourceApi", () {
    unittest.test("method--delete", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(path.substring(pathOffset, pathOffset + 17),
            unittest.equals("api/gallery/v0.1/"));
        pathOffset += 17;
        unittest.expect(path.substring(pathOffset, pathOffset + 15),
            unittest.equals("extension_data/"));
        pathOffset += 15;
      ...
      res
          .delete(arg_extensionId, arg_key, arg_primaryId, arg_secondaryId)
    ...
    unittest.test("method--get", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(
            core.int.parse(queryMap["page"].first), unittest.equals(arg_page));
        unittest.expect(core.int.parse(queryMap["perPage"].first),
            unittest.equals(arg_perPage));
      ...
      res
          .get(arg_extensionId, arg_key,
              ...
              perPage: arg_perPage)
          .then(unittest
              .expectAsync1(((api.PaginatedExtensionDataResponse response) {
    ...
    unittest.test("method--getByPrimaryAndSecondaryId", () {
      ...
      res
          .getByPrimaryAndSecondaryId(
              arg_extensionId, arg_key, arg_primaryId, arg_secondaryId)
          .then(unittest
              .expectAsync1(((api.PaginatedExtensionDataResponse response) {
        checkPaginatedExtensionDataResponse(response);
      })));
    ...
    unittest.test("method--getByPrimaryId", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(queryMap["bidirectional"].first,
  ...
  unittest.group("resource-ImportResourceApi", () {
    unittest.test("method--clearResults", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        subPart =
            core.Uri.decodeQueryComponent(path.substring(pathOffset, index));
        pathOffset = index;
        unittest.expect(subPart, unittest.equals("$arg_batchId"));
        unittest.expect(
            path.substring(pathOffset, pathOffset + 1), unittest.equals("/"));
        pathOffset += 1;
        ...
        unittest.expect(
            queryMap["everything"].first, unittest.equals("$arg_everything"));
      ...
      res
          .clearResults(arg_batchId, everything: arg_everything)
          .then(unittest.expectAsync1((_) {}));
    });

    unittest.test("method--getImportBatch", () {
      var mock = new HttpServerMock();
      api.ImportResourceApi res = new api.GalleryApi(mock).import;
      var arg_batchId = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        var resp = convert.JSON.encode(buildImportBatch());
        return new async.Future.value(stringResponse(200, h, resp));
      }), true);
      res
          .getImportBatch(arg_batchId)
          .then(unittest.expectAsync1(((api.ImportBatch response) {
        checkImportBatch(response);
      })));
    });

    unittest.test("method--getImportBatchResults", () {
      var mock = new HttpServerMock();
      api.ImportResourceApi res = new api.GalleryApi(mock).import;
      var arg_batchId = "foo";
      var arg_page = 42;
      ...
      res
          .getImportBatchResults(arg_batchId,
              page: arg_page, perPage: arg_perPage)
          .then(unittest
              .expectAsync1(((api.PaginatedImportResultsResponse response) {
        checkPaginatedImportResultsResponse(response);
      })));
    });

    unittest.test("method--getImportBatches", () {
      var mock = new HttpServerMock();
      api.ImportResourceApi res = new api.GalleryApi(mock).import;
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        ...
        var resp = convert.JSON.encode(buildListOfImportBatch());
        return new async.Future.value(stringResponse(200, h, resp));
      }), true);
      res
          .getImportBatches()
          .then(unittest.expectAsync1(((api.ListOfImportBatch response) {
        checkListOfImportBatch(response);
      })));
    });
    ...
    unittest.test("method--importFromPath", () {
      ...
      res
          .importFromPath(arg_request)
          .then(unittest.expectAsync1(((api.StringResponse response) {
  ...
  unittest.group("resource-ItemsResourceApi", () {
    unittest.test("method--createItem", () {
      ...
      res
          .createItem(arg_request)
          .then(unittest.expectAsync1(((api.IdResponse response) {
    ...
    unittest.test("method--delete", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(
            queryMap["permanent"].first, unittest.equals("$arg_permanent"));
      ...
      res
          .delete(arg_id, permanent: arg_permanent)
          .then(unittest.expectAsync1((_) {}));
    });
    ...
    unittest.test("method--getTagsByItemId", () {
      ...
      res
          .getTagsByItemId(arg_id)
          .then(unittest.expectAsync1(((api.ListOfTag response) {
    ...
    unittest.test("method--getVisibleIds", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(core.int.parse(queryMap["perPage"].first),
            unittest.equals(arg_perPage));
        unittest.expect(
            queryMap["cutoffDate"].first, unittest.equals(arg_cutoffDate));
        unittest.expect(
            queryMap["inTrash"].first, unittest.equals("$arg_inTrash"));
      ...
      res
          .getVisibleIds(
              page: arg_page,
              perPage: arg_perPage,
              cutoffDate: arg_cutoffDate,
              inTrash: arg_inTrash)
          .then(unittest.expectAsync1(((api.PaginatedItemResponse response) {
    ...
    unittest.test("method--mergeItems", () {
      ...
      res
          .mergeItems(arg_request, arg_targetItemId)
          .then(unittest.expectAsync1(((api.Item response) {
        checkItem(response);
      })));
    });
    ...
    unittest.test("method--restore", () {
      ...
      res.restore(arg_id).then(unittest.expectAsync1((_) {}));
    });
    ...
    unittest.test("method--updateTagsForItemId", () {
      ...
      res
          .updateTagsForItemId(arg_request, arg_id)
          .then(unittest.expectAsync1((_) {}));
    });
  });
  ...
  unittest.group("resource-SetupResourceApi", () {
    unittest.test("method--apply", () {
      ...
      res
          .apply(arg_request)
          .then(unittest.expectAsync1(((api.SetupResponse response) {
  ...
  unittest.group("resource-TagCategoriesResourceApi", () {
    unittest.test("method--create", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        pathOffset += 17;
        unittest.expect(path.substring(pathOffset, pathOffset + 15),
            unittest.equals("tag_categories/"));
        pathOffset += 15;
    ...
    unittest.test("method--getById", () {
      ...
      res
          .getById(arg_id)
          .then(unittest.expectAsync1(((api.TagCategory response) {
  ...
  unittest.group("resource-TagsResourceApi", () {
    unittest.test("method--clearRedirect", () {
      ...
      res
          .clearRedirect(arg_id, arg_category)
          .then(unittest.expectAsync1((_) {}));
    });
    ...
    unittest.test("method--clearRedirectWithoutCategory", () {
      ...
      res
          .clearRedirectWithoutCategory(arg_id)
          .then(unittest.expectAsync1((_) {}));
    });
    ...
    unittest.test("method--delete", () {
      ...
      res
          .delete(arg_id, arg_category)
          .then(unittest.expectAsync1(((api.CountResponse response) {
    ...
    unittest.test("method--getAllTagInfo", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(core.int.parse(queryMap["perPage"].first),
            unittest.equals(arg_perPage));
        unittest.expect(
            queryMap["countAsc"].first, unittest.equals("$arg_countAsc"));
      ...
      res
          .getAllTagInfo(
              page: arg_page, perPage: arg_perPage, countAsc: arg_countAsc)
          .then(unittest.expectAsync1(((api.PaginatedTagResponse response) {
    ...
    unittest.test("method--getRedirects", () {
      ...
      res
          .getRedirects()
          .then(unittest.expectAsync1(((api.ListOfTagInfo response) {
    ...
    unittest.test("method--getTagInfo", () {
      ...
      res
          .getTagInfo(arg_id, arg_category)
          .then(unittest.expectAsync1(((api.TagInfo response) {
    ...
    unittest.test("method--getTagInfoWithoutCategory", () {
      ...
      res
          .getTagInfoWithoutCategory(arg_id)
          .then(unittest.expectAsync1(((api.TagInfo response) {
        checkTagInfo(response);
      })));
    });
    ...
    unittest.test("method--search", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(
            queryMap["countAsc"].first, unittest.equals("$arg_countAsc"));
        unittest.expect(
            queryMap["redirects"].first, unittest.equals("$arg_redirects"));
  ...
  unittest.group("resource-UsersResourceApi", () {
    unittest.test("method--changePassword", () {
      ...
      res
          .changePassword(arg_request, arg_uuid)
          .then(unittest.expectAsync1((_) {}));
    });
