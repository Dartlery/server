...
import 'package:dartlery/views/pages/item_browse/item_browse.template.dart' as ibt;
...
class Routes {
  ...
  final List<RouteDefinition> all = [
    new RouteDefinition(
      ...
      component: ibt.ItemBrowseComponentNgFactory,
    ),
  ];
}
...
//);
//const RoutePath tagsRoute = const RoutePath(
//  path: '/tags',
//  name: 'Tags',
//  component: TagsPage,
//);
