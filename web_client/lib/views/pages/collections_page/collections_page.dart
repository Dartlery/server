...
class CollectionsPage extends AMaintenancePage<api.Collection> {
  ...
  void addBrowser() {
    if (selectedUser != null && this.model != null) {
      ...
      if (!this.model.browserUuids.contains(selectedUser.id)) {
        this.model.browserUuids.add(selectedUser.id);
      }
    }
  }
  ...
  void addCurator() {
    if (selectedUser != null && this.model != null) {
      ...
      if (!this.model.curatorUuids.contains(selectedUser.id)) {
        this.model.curatorUuids.add(selectedUser.id);
      }
    }
  }
