...
class ExtensionService {
  ...
  Future<Null> sendCreatingItem(Item item) => Future.forEach(_extensions.values,
      (AExtension extension) => extension.onCreatingItem(item));
  Future<Null> sendDeletingItem(String itemId) => Future.forEach(
      _extensions.values,
