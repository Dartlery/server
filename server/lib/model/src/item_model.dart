...
class ItemModel extends AIdBasedModel<Item,orm.Uuid> {
  ...
  ItemModel(this._extensionServices, this._tagModel, orm.DatabaseContext db)
      : super(db);
  ...
  Future<String> create(Item item,
    ...
    final String itemId = await db.add(item). itemDataSource.create(item);
